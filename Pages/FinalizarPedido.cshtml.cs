...
namespace SuperOnline.Pages
{
    ...
    {
        private SuperOnlineContext _context;
        ...
        public FinalizarPedidoModel(SuperOnlineContext context, IEmailSender emailSender)
        {
            _context = context;
        ...
        private async Task EnviarEmailResumoPedido()
        {
            ...
            sb.Append($"<p>Ol�, {Cliente.Nome}.<p>");
            sb.Append($"<p>Recebemos seu pedido de compra n�mero {Pedido.IdPedido.ToString("D6")}, no valor total de <b>{Pedido.ValorTotal.ToString("C")}</b>, conforme detalhamento a seguir:<p>");
            ...
            sb.Append($"<p>Em breve seus produtos ser�o entregues no endere�o a seguir:</p>");
            ...
            sb.Append($"<p>Agradecemos pela confian�a em nosso trabalho!</p>");
            sb.Append($"<p>Att.,<br>Equipe Super Online</p>");
            try
            {
